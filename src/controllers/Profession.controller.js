...
export async function getProfessions(req, res) {
  try {
    ...
    if (!lang_code || lang_code === "en") {
      ...
      const professions = await prisma.profession_translations.findMany({
        where: { lang_code },
        include: {
          profession: true,
        },
...
export async function getProfessionById(req, res) {
  try {
    ...
    if (!lang_code || lang_code === "en") {
      ...
      const translation = await prisma.profession_translations.findUnique({
        where: {
          id_lang_code: {
            id: Number(PROF_ID),
            lang_code,
  ...
  try {
    ...
    if (lang_code === "en") {
      ...
      const existingTranslation =
        await prisma.profession_translations.findUnique({
          where: {
            id_lang_code: {
              id: Number(PROF_ID),
              lang_code,
      ...
      if (existingTranslation) {
        ...
        translation = await prisma.profession_translations.update({
          where: {
            id_lang_code: {
              id: Number(PROF_ID),
              lang_code,
        ...
        translation = await prisma.profession_translations.create({
          data: {
            id: Number(PROF_ID),
            PROF_NAME,
            PROF_DESC,
...
export async function deleteProfession(req, res) {
  try {
    ...
    if (lang_code && lang_code !== "en") {
      ...
      await prisma.profession_translations.delete({
        where: {
          id_lang_code: {
            id: Number(PROF_ID),
            lang_code,
      ...
      await prisma.$transaction(async (prisma) => {
        ...
        await prisma.profession_translations.deleteMany({
...
export async function createProfessionTranslation(req, res) {
  try {
    ...
    const existingTranslation = await prisma.profession_translations.findUnique(
      {
        where: {
          id_lang_code: {
            id: Number(PROF_ID),
    ...
    const translation = await prisma.profession_translations.create({
      data: {
        id: Number(PROF_ID),
        PROF_NAME,
        PROF_DESC,
...
export async function getProfessionTranslations(req, res) {
  try {
    ...
    const translations = await prisma.profession_translations.findMany({
      where: { id: Number(PROF_ID) },
    });
...
export async function updateProfessionTranslation(req, res) {
  try {
    ...
    const updatedTranslation = await prisma.profession_translations.update({
      where: {
        id_lang_code: {
          id: Number(PROF_ID),
          lang_code,
